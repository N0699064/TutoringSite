...
function ContactSection() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://formspree.io/f/xkgvwnaz", {
        method: "POST",
        headers: { 
    ...
    <section id="contact" className="section bg-white py-16">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
          Planning to enroll or have any questions about our tutoring classes? Contact us for more information or to schedule a free consultation.
        </p>
                ...
                >
                  ...
                  <div className="flex items-center mt-4">
                    ...
                    <label htmlFor="newsletter" className="ml-2 block text-sm text-gray-700">
                      Subscribe to our newsletter for iCan Tutoring for updates and information
                    </label>
                  </div>
            ...
            <div className="space-y-6">
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">+44 80722 10165</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">michakin@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Offline Classes available</p>
                </div>
              </div>
